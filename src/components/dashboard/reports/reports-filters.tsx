...
export function ReportsFilters({ filters = {}, sortDir = 'desc' }: ReportsFiltersProps): React.JSX.Element {
  ...
  const updateSearchParams = React.useCallback(
    (newFilters: Filters, newSortDir: SortDir): void => {
      ...
      router.push(`${paths.dashboard.reports.list}?${searchParams.toString()}`);
    },
    [router]
  );
