...
export function EntitiesTable({ rows }: EntitiesTableProps): React.JSX.Element {
  const { deselectAll, deselectOne, selectAll, selectOne, selected } = useEntitiesSelection();
